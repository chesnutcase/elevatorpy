...
This library was created for SUTD's 10.009 Digital World 1D project. More details about SUTD's unique learning pedagogy can be found [here]().
...
Python 3.7+ Required for some features in the `asyncio` module.
